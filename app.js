...
app.get('/mandal/mandal_tri', function (req, res) {
	res.render('mandal_tri', {ryu: 'suicied'});
});
...
app.get('/imgs/triangle',function (req, res) {
	res.sendFile(path.join(__dirname+'/public/imgs/triangle.png'));
});

app.get('/imgs/upsidedown',function (req, res) {
	res.sendFile(path.join(__dirname+'/public/imgs/upsidedown_triangle.png'));
});
